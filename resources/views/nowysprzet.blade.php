...
<x-slot name="header">
   ...
   <form method="POST" action="./dodajsprzet" class="w-full max-w-xl bg-white rounded-lg px-4 pt-2">
    @csrf
      ...
      <div class="flex flex-wrap -mx-3 mb-6">
         ...
         <div class="w-full md:w-full px-3 mb-2 mt-2">
            ...
            id="nazwa" name="nazwa" type="text" placeholder="Wpisz informacje">

            <label class="block text-gray-700 text-sm font-bold mt-2" for="ilosc">Ilość</label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="ilosc" name="ilosc" type="number" placeholder="Wpisz informacje">

            <label class="block text-gray-700 text-sm font-bold mt-2" for="data">Data przydatności</label>
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
            id="data" name="data" type="date" placeholder="Wpisz informacje">
